...
print(crossings)
"""
crossings = [(-810, -1066), (-615, -1501), (-927, -1836), (-315, -1355), (-810, -1766), (1620, -3123), (1576, -3123), (-166, -1355), (-810, -1501), (1604, -2698), (2571, -3112), (-1369, -1836), (-174, -1059), (1576, -3375), (-615, -1355), (2274, -3171), (-14, -2267), (1942, -3160), (-480, -1766), (-166, -1614),
             (-737, -1345), (-597, -1766), (1163, -1324), (692, -2267), (-315, -1614), (-174, -1355), (-1179, -1836), (-415, -1620), (-1369, -1217), (1620, -3034), (1181, -1879), (1941, -3171), (-1179, -1885), (1755, -2366), (-315, -1501), (1576, -3034), (-166, -1059), (-737, -1217), (-927, -1885), (-615, -1766)]
"""
...
mini = len(paths[0])
for cross in crossings:
    mini = min(paths[0].index(cross)+paths[1].index(cross), mini)
    print(mini)
...
def wirePoints(wire):
    ...
    for direction in wire:
        ...
        if direction[0] == 'R':
            ...
            x += number
            current_place = (x, y)
        points.append(current_place)
    return points

wire_points = []
for wire in wires:
    wire_points.append(wirePoints(wire))
crossings = dict()

for point1 in range(1, len(wires_points[0])):
    for point2 in range(1, len(wire_points[1])):
        if wire_points[0][point1-1][0] == wire_points[0][point1][0]:
            line1 = wire_points[0][point1][0]:
            x1 = 1
        else:
            line1 = wire_points[0][point1][1]
            x1 = 0
        if wire_points[1][point2-1][0] == wire_points[1][point2][0]:
            line2 = wire_points[1][point2][0]:
            x2 = 1
        else:
            line2 = wire_points[1][point2][1]
            x2 = 0
        if
"""
